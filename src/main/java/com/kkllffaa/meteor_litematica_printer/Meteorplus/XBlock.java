package com.kkllffaa.meteor_litematica_printer.Meteorplus;
import meteordevelopment.meteorclient.events.render.Render3DEvent;
import meteordevelopment.meteorclient.renderer.ShapeMode;
import meteordevelopment.meteorclient.systems.modules.Modules;
import meteordevelopment.meteorclient.systems.modules.render.blockesp.ESPBlockData;
import meteordevelopment.meteorclient.utils.render.color.Color;
import com.kkllffaa.meteor_litematica_printer.Finder;
...
public class XBlock {
	...
	private static final Finder search = Modules.get().get(Finder.class);
	...
	public void render(Render3DEvent event, Finder.RenderOre ore) {
		if (ore.block != null) {
			double x1 = x;
			double y1 = y;
			double z1 = z;
